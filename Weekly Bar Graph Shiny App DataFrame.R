...
concept$metric_type <- "Run Concepts"
shell$metric_type <- "Shell Coverages"
air_yards$metric_type <- "Air Yards"
route$metric_type <- "Targeted Routes"
ttp$metric_type <- "Time to Pass"
ttpr$metric_type <- "Time to Pressure"
downs$metric_type <- "Downs"
ydstogo$metric_type <- "Yards to Go"
run_gap$metric_type <- "Run Gap"
play_action$metric_type <- "Play Action"
pressure_allowed$metric_type <- "Pressure Allowed"
pass_rushers$metric_type <- "Pass Rushers"
men_in_box$metric_type <- "Men in Box"
qb_pos$metric_type <- "QB Position"
wp$metric_type <- "Win Probability"
yards_gained$metric_type <- "Yards Gained"
field_pos$metric_type <- "Field Position"
run_pass$metric_type <- "Run vs Pass"
dropback_result$metric_type <- "Dropback Result"
no_huddle$metric_type <- "No Huddle"
